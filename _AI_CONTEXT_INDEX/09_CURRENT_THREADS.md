...
| **Al Jazeera satellite finding** | Strike pattern **bypassed** the Shahid Absalan Specialist Clinic between school and IRGC base, then hit clinic separately after it began treating school victims. Inconsistent with "outdated maps" — precision targeting excluded clinic but hit school. | ⚠️ PARTIALLY VERIFIED — Multiple sources reference clinic strike; specific "bypassed" characterization needs re-verification against primary Al Jazeera investigation |
