...
| **Apr 5** | **Planet Labs announces indefinite satellite imagery blackout over Iran/Middle East at US government request — OSINT/journalism transparency layer severed; PL stock +17% YTD** |
...
| **Enforcement mechanism** | Documented escalation pattern — Corporate → Government → Intelligence: (1) Candace Owens departed Daily Wire after criticizing Israel (2024), (2) Carrie Prejean Boller fired from Religious Liberty Commission by Dan Patrick/Trump for raising Catholic theology against Zionist framing (Feb-March 2026), (3) Tucker Carlson — CIA criminal referral reportedly under consideration for FARA after talking to Iranians and platforming dissenters (March 2026). **Tucker enforcement contrast note**: Tucker faces potential criminal referral for *dissenting* from the enforced theology while TPUSA under Erika Kirk simultaneously receives a DoD Board of Visitors seat, a governor's proclamation embedding chapters in state schools, and the White House press secretary as tour co-host. The enforcement mechanism operates in both directions simultaneously — criminal exposure for dissent, institutional integration for alignment. | Source: `15_The_Religious_Layer/The_Lever.md`, Tucker Carlson Show, JTA, Jewish Insider |
...
*Changes in this update:*
- *Node 2 (Iran war): Added Apr 2 military leadership purge — Gen. Randy George (Army CSA), Gen. David Hodne (Army T&T Cmd), Maj. Gen. William Green Jr. (Chief of Chaplains — first in US history). Gen. LaNeve named acting CSA. ✅ VERIFIED — CBS News, CNBC, Politico, Al Jazeera, Defense Scoop.*
- *March/April 2026 Events table: Added Apr 2 entries (NCPC 8-1 bypass vote; Bondi firing; military purge) and Apr 3 entries (Ty Cobb 25th Amendment call; UMass/YouGov 33% / Economist/YouGov 35% approval). All ✅ VERIFIED.*
- *New file: `_AI_CONTEXT_INDEX/Node_Dossiers/tier2_purged_officials.md` — running log of second-term removals (Bongino, Noem, Bondi, George, Hodne, Green).*
- *CONTEXT_ROUTER.md: Added routing entries for purged officials dossier and related entities.*
