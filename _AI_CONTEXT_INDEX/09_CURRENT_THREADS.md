...
| **Epstein Network** | Information (documentation) | 4,700+ bin Sulayem mentions; Maxwell leverage; Mueller testimony permanently lost (March 21) | Network exposure driving resignations; key witness testimony inaccessible |
...
| **Falsification criteria** | If April 12–20 passes with NO major competing events AND Bondi deposition AND CLARITY Act vote AND FISA reauthorization receive sustained prominent coverage, the distraction prediction is falsified |
| Framework significance | [Inference] Tests the thermostat model's predictive power: **quadruple-track convergence** (accountability + capital architecture + election infrastructure + Cuba/CRINK energy) within a defined, pre-filed window. Four institutional tracks in a single week each individually dominate a news cycle; together they fragment attention — the thermostat model's predicted behavior. |
| Last updated | April 1, 2026 (Track D added: Treasury Cuba/NK waiver expiration April 11; window expanded to April 11–20) |
...
| **SpaceX IPO** | Confidential SEC filing submitted **April 1, 2026**. Nasdaq listing targeted **June–July 2026**; valuation target $1.5–1.75T; expected to raise $50B–$80B (would be largest IPO in history). Lead underwriters: Goldman Sachs, Morgan Stanley, JPMorgan Chase, Bank of America. Dual-class share structure under consideration. Up to 30% retail investor allocation. Public S-1 prospectus expected late April–May. | ✅ VERIFIED — [CNBC](https://www.cnbc.com/2026/04/01/spacex-confidentially-files-for-ipo-setting-stage-for-record-offering.html), [Forbes](https://www.forbes.com/sites/danirvine/2026/03/25/spacex-may-file-for-a-june-ipo-as-valuation-estimates-soar/), [Teslarati](https://www.teslarati.com/spacex-files-sec-official-ipo-june/), [Fortune](https://fortune.com/2026/02/02/elon-musk-spacex-xai-ipo-trillion/) |
...
*Last Updated: April 8, 2026 (v12.3 — April 5-7 Iran ceasefire events; Carlson–Trump break deepens)*
