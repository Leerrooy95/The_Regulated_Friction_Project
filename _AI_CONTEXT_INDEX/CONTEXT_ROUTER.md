...
| **Iran "no navy" claim / FBI drone threat / homeland warnings** | `06_ATTENTION_ECONOMY.md` (Section 7) | `09_CURRENT_THREADS.md` (Node 2), `05_CRINK_FRAMEWORK.md` (Iran Homeland Threat section), `Project_Trident/Copilot_Opus_4.6_Analysis/Iran_Naval_Fleet_FBI_Drone_Bulletin_Verification.md` |
| **FBI California drone bulletin / sleeper cells** | `05_CRINK_FRAMEWORK.md` (Iran Homeland Threat section) | `09_CURRENT_THREADS.md` (Node 2), `06_ATTENTION_ECONOMY.md` (Section 7) |
...
| **Evangelical networks** | `Project_Trident/Copilot_Opus_4.6_Analysis/Evangelical_Network_Cross_Reference_Analysis.md` | — |
