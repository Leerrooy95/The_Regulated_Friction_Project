...
| **Tony Blair Node** | `tier1_blair_node.md` | Tony Blair, Tony Blair Institute (TBI), Board of Peace, Gaza Executive Board, Quartet, Larry Ellison (funding), Peter Mandelson (adjacent), Ehud Barak, NHS National Data Library, Sharm el-Sheikh Oct 2025, World Governments Summit Dubai | Three-function operator: legitimacy anchor for Board of Peace (only non-US citizen in 20-point plan), Oracle deployment vehicle via TBI (£257M Ellison funding since 2021), and Board of Peace co-architect (helped develop the framework before its January 2026 announcement). Mandelson-Epstein connection contextualized but not load-bearing. |
